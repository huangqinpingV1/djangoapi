...
class User(models.Model):
    GENDER_CHOICES = ((0,'男'),(1,'女'),(2,'保密'),(3,'未设置'))
    ...
    gender =models.IntegerField(default='3',verbose_name ='用户性别')
    ...
    addr = models.CharField(max_length  =233,null  =True,verbose_name='用户地址')
    qq = models.CharField(max_length =255,null =True,verbose_name='绑定qq')
    weixin = models.CharField(max_lenght =255,null =True,verbose_name='绑定微信')
